    ...
    <el-container id="id_mark_detail">
        <el-header>
            <div style="float:right">
                    <el-button size="small" type="primary" @click="onClickStep(step_index-1)" icon="el-icon-arrow-left">上一步</el-button>
                    <el-button size="small" type="primary" @click="onClickStep(step_index+1)">下一步<i class="el-icon-arrow-right el-icon--right"></i></el-button>
            </div>
            <div style="margin-right:220px">
                    <el-steps  :active="step_index" finish-status="success" align-center>
        ...
        <el-main>
            <!-- step 0 -->
            <el-row :gutter="5" v-show="step_index == 0">
                <el-col :span="14" :offset="2">
                    <p>即将从这些样本进行标记，完成对这一类网页的结构化设定</p>
                    <el-input type="textarea" :autosize="{minRows: 6, maxRows: 10}" placeholder="每行一个URL" v-model="input_sample">
                    </el-input>
                </el-col>
            </el-row>

            <!-- step 1 -->
            <el-row :gutter="10" v-show="step_index == 1">
                <el-col :span="16">
            ...
            <!-- step 2 -->
            <el-row :gutter="10" v-show="step_index == 2">
                <p>STEP_2</p>
            </el-row>

            <!-- step 3 -->
            <el-row :gutter="10" v-show="step_index == 3">
                <p>STEP_3</p>
            </el-row>

            <!-- step 4 -->
            <el-row :gutter="10" v-show="step_index == 4">
                <p>OK</p>
            </el-row>

            <ul id="id_sel_list" v-bind:style="style_sel_list" class="el-scrollbar__view el-select-dropdown__list" v-show="sel_data.sel_menu_visible && step_index == 1">
